...
app.controller("step6Ctrl",['$scope', '$rootScope', '$state', '$http', function ($scope, $rootScope, $state, $http) {
    ...
    .then(function(response) {
      ...
      function(response) { // optional
        alert("Couldn't save your assessment. Please, try again.")
      }
    );

		/*if (typeof rootRef != "undefined") {
			rootRef.p
      ush(response, function (error) {
				if (error) {
